        ...
        <v-col cols="10">
          <v-card style="width: 100%">
            ...
            <v-row class="text-center">
              <v-col v-for="item in plans" :key="item.id" :class="columnSize">
                <div class="flex-center">
                  <v-card-text>
                    <div class="flex-center">
                      <div class="circle1">
                        <div class="circle2">
                          <v-img
                            :src="require(`@/assets/img/paperplane.svg`)"
                          ></v-img>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="text-uppercase blue--text">
                      Number of employee: {{ item.numOfEmployee }}
                    </div>
                    <v-divider class="my-2" />
                    <div class="text-uppercase blue--text">
                      Size of drive: {{ item.sizeOfDrive }}
                    </div>
                    <v-divider class="my-2" />
                    <div class="text-uppercase blue--text">
                      Current have {{ item.numOfUser }} user
                    </div>
                    <v-divider class="my-2" />
                  ...
                  <v-divider
                    ...
                    vertical
                    v-if="this && this.$vuetify.breakpoint.smAndUp"
                  ></v-divider>
                </div>
                <v-divider
                  class="mx-4"
...
export default {
  ...
  computed: {
    ...
    columnSize() {
      const numb = this.plans.length;
      let result = 12 / numb;
      return `col-12 col-sm-6 col-md-${{ result }}`;
    }
  }
};
</script>
